...
Esta función realiza búsquedas históricas de tweets con hashtags
específicos de forma iterativa, permitiendo recolectar tweets en
intervalos de tiempo específicos (días, horas o minutos).
...
- hashtag:
  ...
  Hashtag específico para buscar en los tweets.
...
3.  Ejecuta búsquedas históricas de tweets con el hashtag especificado
    de forma iterativa.
