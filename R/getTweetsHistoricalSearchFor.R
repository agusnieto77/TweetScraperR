...
getTweetsHistoricalSearchFor <- function(
  ...
  .Deprecated(msg = "getTweetsHistoricalSearchFor() est\u00e1 obsoleta: us\u00e1 getTweetsSearchAPI() (basada en la API de X, datos estructurados del JSON, m\u00e1s robusta). Ver ?getTweetsSearchAPI.")
