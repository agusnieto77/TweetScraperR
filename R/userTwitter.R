...
#' de la variable de entorno TWITTER_USER y, si no está definida, el de la variable de
#' entorno del sistema USER, obtenido mediante `Sys.getenv("TWITTER_USER", Sys.getenv("USER"))`.
#'
