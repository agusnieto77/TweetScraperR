...
en tiempo real en Twitter. Utiliza autenticación en Twitter mediante el
...
por el parámetro `n_urls` o hasta que se realizan varios intentos
...
URLs de los tweets recolectados se almacenan en un vector y, si el
parámetro `save` es TRUE, se guardan en un archivo con formato `.rds` en
el directorio especificado por el parámetro `dir`. Este archivo se
nombra de manera única utilizando la consulta de búsqueda y la marca de
tiempo del momento en que se realiza la recolección, asegurando que no
